...
ffmpeg -i "%MP4_FILE%" -filter_complex "[0:v]lut3d=file=%CUBE_FILE%[lut];[lut]hue=h=sin(t/5)*180[out]" -map "[out]" -c:v libx264 "%MP4_FILE:~0,-4%_%CUBE_FILE:~0,-5%_hue-shift.mp4"
